...
\begin{document}
	...
	\cvsection{PROFILE}
		...
		Motivated software engineering student looking for an internship or co-op during \textbf{summer and/or fall 2020}. \\ Experience in:
		
		\vspace{-0.1cm}
		\begin{center}
		\begin{tabular}{l@{\hskip 2cm}l}
		\tabitem Full Stack JS Web Development & \tabitem Subsystem Design and Architecture \\
		\tabitem Object Oriented Design & \tabitem Agile and Scrum \\
		\tabitem Android and Mobile Development  & \tabitem Version Control Systems
		\end{tabular}
