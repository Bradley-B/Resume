		...
		\cvsection{SKILLS}
			...
			\begin{itemize}[nosep]
				...
				\item \textbf{ACTIVELY LEARNING}
					\begin{itemize}[nosep]
					\item C, Ruby, Bash, SQL, HTML/CSS, JavaScript, \LaTeX
				\end{itemize}
			\end{itemize}
			
			\textbf{\textit{PROGRAMS / ENVIRONMENTS}}
				\begin{itemize}[nosep]
					\item Android Studio, GNU/Linux and Unix-like systems, Vim, Git, Jetbrains products, Microsoft Office products
				\end{itemize}
			...
			\textbf{\textit{CONCEPTS}}
				\begin{itemize}[nosep]
					...
					\item Web and System Development
					\item Networking 
				\end{itemize}
